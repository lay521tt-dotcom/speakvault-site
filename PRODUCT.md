...
- in-app record safety self-check for storage, mirror, and backup payload readability;
...
- local JSON export/import with non-destructive merge, copyable backup text, and overdue-backup browser reminder for protecting the study notebook;
